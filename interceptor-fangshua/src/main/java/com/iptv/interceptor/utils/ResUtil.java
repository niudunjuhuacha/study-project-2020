...
public class ResUtil {
     ...
     * @return "{code:ResultCode.ILLEGAL_PARAM(400),msg:xx}"
     */
    public static String get400ErrDes(String des) {
        return ResUtil.getJsonStr(ResultCode.BAD_REQUEST, des);
    }
     ...
     *
     * @param des
     * @return "{code:506,msg:xx}"
     */
    public static String getErr506(String des) {
        return ResUtil.getJsonStr(ResultCode.PROMPT_ERROR_CODE, des);
    }


    public static String getTvClouseErr(){
        return ResUtil.getJsonStr(ResultCode.TV_CLOUSE_CODE,"连接断开,请将电视返回首页后重试!");
    }
